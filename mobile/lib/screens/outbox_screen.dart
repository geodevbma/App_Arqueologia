...
class _OutboxScreenState extends ConsumerState<OutboxScreen> {
  ...
  Widget build(BuildContext context) {
    final pending = ref.watch(collectionsProvider(true));
    final rows = pending.asData?.value ?? const <Map<String, dynamic>>[];
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const PremiumHeader(
            ...
            subtitle:
                'A sincronizacao ocorre automaticamente quando ha internet. '
                'Voce tambem pode enviar manualmente.',
          ),
